...
FILESPATH =. "${FILE_DIRNAME}/linux-dominion-4.20:${FILE_DIRNAME}/linux-dominion-4.20/${MACHINE}:"

S = "${WORKDIR}/git"

PV = "4.20.8"

SRC_URI = "git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git;protocol=https;branch=linux-4.20.y"
SRCREV_pn-${PN} = "0788acb1a3ed1589da1768ba64b1e5c76e8cb661"
